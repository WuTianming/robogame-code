...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, actuator1_Pin|actuator2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PH7 PH9 PH13 PH15 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_9|GPIO_PIN_13|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PCPin PCPin */
  GPIO_InitStruct.Pin = actuator1_Pin|actuator2_Pin;
