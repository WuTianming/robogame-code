...
#define USART6_TX_UNUSED_Pin GPIO_PIN_6
#define USART6_TX_UNUSED_GPIO_Port GPIOC
#define DR16_RX_Pin GPIO_PIN_7
#define DR16_RX_GPIO_Port GPIOC
#define m2r_pwm_Pin GPIO_PIN_0
#define m2r_pwm_GPIO_Port GPIOI
#define m1r_en_Pin GPIO_PIN_13
#define m1r_en_GPIO_Port GPIOG
